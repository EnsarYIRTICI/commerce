...
export class  $npmConfigName1730573862199 implements MigrationInterface {
    name = ' $npmConfigName1730573862199'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP, CONSTRAINT "UQ_22cc43e9a74d7498546e9a63e77" UNIQUE ("name"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_variant_attribute_values_product_attribute_value" ("productVariantId" integer NOT NULL, "productAttributeValueId" integer NOT NULL, CONSTRAINT "PK_2927619bb2b3c6ae903b948df11" PRIMARY KEY ("productVariantId", "productAttributeValueId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e8541545e51a2f53e65618f675" ON "product_variant_attribute_values_product_attribute_value" ("productVariantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_aebfcf8540c93d30a6bcb63fbc" ON "product_variant_attribute_values_product_attribute_value" ("productAttributeValueId") `);
        ...
        await queryRunner.query(`ALTER TABLE "product_variant_attribute_values_product_attribute_value" ADD CONSTRAINT "FK_e8541545e51a2f53e65618f6754" FOREIGN KEY ("productVariantId") REFERENCES "product_variant"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "product_variant_attribute_values_product_attribute_value" ADD CONSTRAINT "FK_aebfcf8540c93d30a6bcb63fbc0" FOREIGN KEY ("productAttributeValueId") REFERENCES "product_attribute_value"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_variant_attribute_values_product_attribute_value" DROP CONSTRAINT "FK_aebfcf8540c93d30a6bcb63fbc0"`);
        await queryRunner.query(`ALTER TABLE "product_variant_attribute_values_product_attribute_value" DROP CONSTRAINT "FK_e8541545e51a2f53e65618f6754"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_aebfcf8540c93d30a6bcb63fbc"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e8541545e51a2f53e65618f675"`);
        await queryRunner.query(`DROP TABLE "product_variant_attribute_values_product_attribute_value"`);
